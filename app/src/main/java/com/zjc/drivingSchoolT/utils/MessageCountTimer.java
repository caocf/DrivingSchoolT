...
public class MessageCountTimer extends CountDownTimer {
     ...
     */
    public MessageCountTimer(long millisInFuture, long countDownInterval, TextView btn, int endStrRid) {
     ...
     * 参数上面有注释
     */
    public MessageCountTimer(TextView btn, int endStrRid) {
        super(TIME_COUNT, 1000);
        this.btn = btn;
        this.endStrRid = endStrRid;
    }

    public MessageCountTimer(TextView btn) {
        super(TIME_COUNT, 1000);
        this.btn = btn;
    ...
    public MessageCountTimer(TextView tv_varify, int normalColor, int timingColor) {
        this(tv_varify);
