...
import com.zjc.drivingSchoolT.eventbus.StudyDistributionEvent;
import com.zjc.drivingSchoolT.ui.main.adapter.StudyOrderAdapter;
...
//        startActivity(StudyOrderActivity.class, bundle);
    ...
    public void onRefresh() {
        ApiHttpClient.getInstance().findOrders(SharePreferencesUtil.getInstance().readUser().getUid(), ConstantsParams.PAGE_START, new ResultResponseHandler(getActivity(), mRecyclerView) {
