package com.zjc.drivingSchoolT.db.SharePreferences;
...
public class SerializableUtil {
    ...
    public static <E> List string2List(String str) throws StreamCorruptedException, IOException, ClassNotFoundException {
